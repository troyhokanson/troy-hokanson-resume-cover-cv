...
**How it works:** When you say "Write a cover letter for a Fraud Analyst role," the GPT will automatically trigger the action, fetch the live standards from GitHub, and apply them.

---

## 2. Claude (claude.ai Projects)

Claude Projects cannot do live web fetching via Actions, but they have a massive context window and "Project Knowledge."
...
**How it works:** Claude will read the uploaded files as its ground truth. *Note: If you update the standards in GitHub, you must re-upload the files to Claude's Project Knowledge.*
...
Perplexity Spaces are great for research, but if you use them for drafting:
